...
class Plotter:
    ...
    def show_correlation_cont_data(self):
        df_raw_continuous = self.df_raw[["loan_amount", "funded_amount", "funded_amount_inv", "int_rate", "instalment", "annual_inc", "dti", "delinq_2yrs", "inq_last_6mths", "open_accounts", "total_accounts", "out_prncp", "out_prncp_inv", "total_payment", "total_payment_inv", "total_rec_prncp", "total_rec_int", "total_rec_late_fee","recoveries", "collection_recovery_fee", "last_payment_amount", "collections_12_mths_ex_med"]]
...
show_correlation = visuals.show_correlation_cont_data()
...
class DataFrameOutliersTransform:
    ...
    def iqr_outliers_removal(self):
        iqr_columns = ["funded_amount_inv", "delinq_2yrs", "total_rec_prncp", "int_rate", "instalment", "dti", "total_payment", "total_payment_inv"]
        ...
        for iqr_colm in iqr_columns:
            ...
            #print(outliers)
            #print(self.df_raw)
            print(f'{iqr_colm}', len(self.df_raw))
    ...
    def flooring_capping_outliers_removal(self):
        ...
        for fl_cp_column in floor_cap_columns:
            ...
            print(f'{fl_cp_column}', self.df_raw[fl_cp_column].min(), self.df_raw[fl_cp_column].max() )
    ...
    def transform_outliers_median(self):
        ...
        for out_med_column in outliers_median:
            ...
            high_percentile = np.quantile(self.df_raw[out_med_column], 0.95)
            ...
            print(f'{out_med_column}', self.df_raw[out_med_column].max() )
